...
undo_img=pygame.image.load('res\\undo.png')
undo_img=pygame.transform.scale(undo_img,DEFAULT_IMAGE_SIZE)
#redo_img=pygame.image.load('res\\redo.png')
#redo_img=pygame.transform.scale(redo_img,DEFAULT_IMAGE_SIZE)
...
class Game:
    ...
    def game(self):
        ...
        #button
        undo_button=button(580,0,undo_img)
        undo_button.draw()
